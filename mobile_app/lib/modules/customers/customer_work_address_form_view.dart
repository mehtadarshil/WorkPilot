            ...
            children: [
              ...
              customerPanel(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    Text('ADDRESS NAME *', style: _labelStyle()),
                    const SizedBox(height: 6),
                    TextField(
                      controller: _name,
                      enabled: !_saving,
                    ...
                    const SizedBox(height: 12),
                    Text('CITY / COUNTY', style: _labelStyle()),
                    const SizedBox(height: 6),
                    TextField(
                      controller: _county,
                      enabled: !_saving,
              ...
              customerSectionHeader('Site contact'),
              customerPanel(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                ...
                child: Column(
                  ...
                  children: [
                    CheckboxListTile(
                      ...
                      title: Text('Phone call', style: GoogleFonts.inter(color: AppColors.slate900)),
                    ...
                    CheckboxListTile(
                      ...
                      title: Text('SMS', style: GoogleFonts.inter(color: AppColors.slate900)),
                      activeColor: AppColors.primary,
                      contentPadding: EdgeInsets.zero,
                    ),
                    CheckboxListTile(
                      ...
                      title: Text('Email', style: GoogleFonts.inter(color: AppColors.slate900)),
                      activeColor: AppColors.primary,
                      contentPadding: EdgeInsets.zero,
                    ),
                    CheckboxListTile(
                      ...
                      title: Text('Letter', style: GoogleFonts.inter(color: AppColors.slate900)),
                      activeColor: AppColors.primary,
                      contentPadding: EdgeInsets.zero,
                    ),
                  ],
