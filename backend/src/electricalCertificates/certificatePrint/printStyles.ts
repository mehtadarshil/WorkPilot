export const CERTIFICATE_PRINT_CSS = `
  ...
  .cp-outcome-badge {
    ...
    font-size: 6.5pt; font-weight: 800; line-height: 1; vertical-align: middle;
  }
  .cp-outcome-empty { color: #9ca3af; font-weight: 400; }
  .cp-legend {
    display: flex; flex-wrap: wrap; gap: 4px 8px; margin: 0 0 6px; padding: 4px 6px;
    border: 1px solid #d1d5db; background: #f9fafb; font-size: 6pt;
  }
  .cp-legend-item { display: inline-flex; align-items: center; gap: 3px; white-space: nowrap; }
  .cp-assessment {
    display: inline-block; padding: 6px 14px; font-size: 11pt; font-weight: 900;
    letter-spacing: 0.06em; text-transform: uppercase; border-radius: 2px;
  }
  .cp-assessment-neutral {
    display: inline-block; padding: 4px 8px; font-size: 9pt; font-weight: 700;
    border: 1px solid #d1d5db; background: #f3f4f6;
  }
  .assessment-label { margin: 0 0 4px; font-size: 7pt; font-weight: 700; color: #4b5563; }
  .cp-check {
    display: inline-flex; align-items: center; justify-content: center;
    width: 11px; height: 11px; border-radius: 999px; font-size: 7pt; font-weight: 900; line-height: 1;
  }
  ...
  .cp-schedule-section-title {
    margin: 0 0 3px; padding: 3px 6px; background: #1e293b; color: #fff;
    font-size: 7pt; font-weight: 800; text-transform: uppercase;
  }
  .cp-board-title {
    margin: 0 0 3px; padding: 4px 6px; font-size: 9pt; font-weight: 800;
    background: #111; color: #fff; text-transform: uppercase;
  }
  .cp-board-subtitle { margin: 0 0 2px; font-size: 7pt; font-weight: 800; color: #111; }
  .cp-board-details {
    width: 100%; border-collapse: collapse; table-layout: fixed; margin-bottom: 3px; font-size: 6pt;
  }
  .cp-board-details td { border: 1px solid #b7b7b7; padding: 2px 3px; background: #f3f4f6; vertical-align: top; }
  .cp-circuit-table {
    width: 100%; border-collapse: collapse; table-layout: fixed; font-size: 5.6pt; border: 1px solid #8b8b8b;
  }
  .cp-circuit-table th, .cp-circuit-table td {
    border: 1px solid #b7b7b7; padding: 1px 1.5px; text-align: center; vertical-align: middle; line-height: 1.05;
  }
  .cp-circuit-table .cp-group-row th {
    background: #374151; color: #fff; font-size: 5pt; font-weight: 800; padding: 2px;
    text-transform: uppercase; letter-spacing: 0.03em;
  }
  .cp-circuit-table .cp-col-row th { background: #d9d9d9; font-size: 5pt; font-weight: 800; height: 52px; padding: 1px; }
  .cp-circuit-table .cp-col-row th.cp-th-v {
    writing-mode: vertical-rl; transform: rotate(180deg); white-space: nowrap;
    height: 58px; max-width: 12px; overflow: hidden;
  }
  .cp-circuit-table .cp-col-row th.cp-th-h { height: auto; white-space: normal; }
  .cp-circuit-table td.cp-desc {
    text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; font-weight: 600;
  }
  ...
  .cp-form-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 4px; margin-top: 4px; }
  .cp-form-field { border: 1px solid #d1d5db; min-height: 26px; display: flex; flex-direction: column; background: #fff; }
  .cp-form-label { background: #f3f4f6; padding: 2px 4px; font-size: 5.8pt; font-weight: 800; color: #374151; border-bottom: 1px solid #e5e7eb; }
  .cp-form-value { padding: 3px 4px; font-size: 6.5pt; color: #111; min-height: 14px; }
  .cp-guidance { font-size: 7pt; line-height: 1.35; white-space: pre-wrap; color: #111; }
  .cp-recommendations { margin-top: 8px; padding: 6px 8px; border: 1px solid #d1d5db; background: #f9fafb; font-size: 7pt; line-height: 1.35; }
  ...
  .cp-signature-box { min-height: 42px; border: 1px solid #9ca3af; background: #fff; display: flex; align-items: center; justify-content: center; padding: 4px; }
