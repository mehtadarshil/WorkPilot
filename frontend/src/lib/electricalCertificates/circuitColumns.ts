...
export const CIRCUIT_COLUMNS: CircuitColumnDef[] = [
  ...
  { key: 'insulationTestVoltage', label: 'Test voltage V', group: 'insulation', width: 'w-16' },
  { key: 'insulationLL', label: 'L-L MΩ', group: 'insulation', width: 'w-14' },
  { key: 'insulationLE', label: 'L-E MΩ', group: 'insulation', width: 'w-14' },
  { key: 'polarity', label: 'Polarity', width: 'w-14' },
  { key: 'zs', label: 'Measured Zs Ω', width: 'w-14', calculated: true },
