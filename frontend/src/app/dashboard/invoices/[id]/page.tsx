  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        @media print {
          /* Hide app chrome; keep invoice in normal flow so it matches on-screen layout */
          ...
          #invoice-detail-page .invoice-page-body {
            overflow: visible !important;
            padding: 0 !important;
          }
          #invoice-print,
      ...
      <div className="no-print flex items-end justify-between overflow-x-auto border-b border-slate-200 bg-white px-6 pt-2">
        <div className="flex gap-1">
          <button
            ...
            className={`whitespace-nowrap rounded-t-md border-b-2 px-4 py-3 text-[13px] transition-all ${
              activeTab === 'details'
