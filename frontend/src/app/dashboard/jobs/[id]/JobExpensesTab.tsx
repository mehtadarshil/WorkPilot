...
import { Camera, ImageIcon, Plus, ReceiptText } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h3 className="text-lg font-bold text-slate-900">Add job expense</h3>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <span className="mb-1 block text-sm font-semibold text-slate-700">Receipt photo (optional for office)</span>
