...
/**
 * Compatibility route for MS OAuth when /api/auth/microsoft/callback is used as the redirect URI
 * but we want the same behavior as /auth/microsoft/callback.
 */
export default function MicrosoftApiCallback() {
  useEffect(() => {
